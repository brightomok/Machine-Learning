...
model1 <- randomForest(classe ~. , data=train_raw[,-c(1:7)], method="class", proximity = TRUE)
...
Predicting off of the summary statistics is much less accurate. The most differentiating variable is the pitch of the belt sensor. This quickly distinguishes a lot of cases where the individual performs a Class E mistake ("throwing the hips to the front").
